...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Notes",
          description: "A collection of notes I have compiled on interesting topics in physics and mathematics. These are created mostly for my personal reference; they are more concise and less clear than course notes one may find on the same topic. I don&#39;t promise these are without mistakes; if you find an error, please don&#39;t hesitate to let me know. I provide the dates for the creation of each page; I make fewer guarantees on the quality of notes with their age. I also especially do not guarantee that the notation I use is consistent throughout. I oft change my preferences on the meanings of symbols and letters, but at least within each noteset, I have attempted to ensure that the notation is self-consistent. In the future, I may provide notes on Oppenheimer-Snyder Stellar Collapse, the Weierstrass function, the stability of thin-core vortex rings, the effective viscosity of a spherical suspension, or any other neat topic I encounter in my classes or research.",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-on-the-schwarzschild-and-kerr-metrics-12-25",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-vortex-ring-mediated-jellyfish-feeding",
          title: 'Vortex Ring-Mediated Jellyfish Feeding',
          description: "",
          section: "Projects",handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-elasticity-theory-and-the-deformation-of-two-colliding-disks-1-25",
