...
<div style="text-align: center;">
  {% include figure.liquid loading="lazy" path="assets/img/Pictures-Website_Millholland2023/TOImigrationchart(7x7).png" title="TOI Migration Chart" class="img-fluid rounded z-depth-0" width="500" height="auto" %}
</div>

<p> The results of our study can be found in our publication {% cite Millholland2024 %}.
